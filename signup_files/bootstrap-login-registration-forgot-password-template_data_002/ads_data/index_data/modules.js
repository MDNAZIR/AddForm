...
(function() {
    function chooseExitURL(desktopExitURL, iosExitURL, androidExitURL) {
        ...
        console.log("isiOS? " + Utils.isiOS);
        console.log("the exit url = " + exitURL);
        console.log(exitURL || desktopExitURL);
            ...
            if (!monetDataProvider.primaryAssetsPromise) {
                ...
                monetDataProvider.primaryAssetsPromise = new Promise(function(resolve, reject) {
                    monet.load(monetRequestParams, function(monetAssets) {
                        doHTTPRequest(monetDataProvider.backupLocation || STATIC_BACKUP_LOCATION).then(function(backupMonetAssets) {
                            var backupMonetAssets = JSON.parse(backupMonetAssets);
                            var backup = false;
                            for (var i in backupMonetAssets.rootAssets) {
                                if (!monetAssets.rootAssets[i]) {
                                    backup = true;
                                    monetAssets.rootAssets[i] = backupMonetAssets.rootAssets[i];
                                    monet.logEvent("MONET_DATA_VALIDATION_ERROR", {
                                        details: "Key `" + i + "` not found in Monet data; using backup value."
                                    });
                                }
                            }
                            if (backup) {
        ...
        var component = Object.create(HTMLElement.prototype, {
            attachedCallback: {
                value: function() {
                    ...
                    this.resize();
                    this.n_leftShape = drawPath("M 45 2 L 0 2 0 235 Q 17 231 45 232 L 45 2 Z", "#E50914", {
                        x1: "-48",
                        y1: "-141",
                        x2: "-38",
                        y2: "-144"
                    ...
                    this.n_rightShape = drawPath("M 127 2 L 83 2 83 219 127 235 127 2 Z", "#E50914", {
                        x1: "104",
                        y1: "140",
                        x2: "84",
                        y2: "146"
                    ...
                    this.e_mainShape = drawPath("M 206 3 L 167 3 167 227 206 227 206 3 Z", "#E50914", {
                        x1: "190",
                        y1: "65",
                        x2: "190",
                        y2: "24",
                    ...
                    this.e_bottomShape = drawPath("M 274 186 L 167 188 167 227 274 225 274 186 Z", "#E50914", {
                        x1: "232",
                        y1: "204",
                        x2: "197",
                        y2: "205",
                    ...
                    this.t_midShape = drawPath("M 381 8 L 341 8 341 224 381 222 381 8 Z", "#E50914", {
                        x1: "366",
                        y1: "69",
                        x2: "366",
                        y2: "29",
                    ...
                    this.f_mainShape = drawPath("M 488 18 L 448 18 448 222 488 222 488 18 Z", "#E50914", {
                        x1: "472",
                        y1: "69",
                        x2: "472",
                        y2: "28",
                    ...
                    this.l_mainShape = drawPath("M 624 0 L 584 0 584 223 624 223 624 0 Z", "#E50914", {
                        x1: "599",
                        y1: "158",
                        x2: "599",
                        y2: "201",
                    ...
                    this.x_backShape = drawPath("M 891 248 L 934 254 837 0 794 0 891 248 Z", "#E50914", {
                        x1: "946",
                        y1: "-104",
                        x2: "1011",
                        y2: "-64",
